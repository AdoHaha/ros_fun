...
.. code-block:: bash
   ...
   $ py-trees-render -b ros_fun_py_trees_ros_tutorials.eight_dynamic_application_loading.tutorial_create_root

.. graphviz:: dot/tutorial-eight-core-tree.dot
   :align: center
   :caption: ros_fun_py_trees_ros_tutorials.eight_dynamic_application_loading.tutorial_create_root
...
.. code-block:: bash
   ...
   $ py-trees-render --with-blackboard-variables ros_fun_py_trees_ros_tutorials.eight_dynamic_application_loading.tutorial_create_scan_subtree

.. graphviz:: dot/tutorial-eight-application-subtree.dot
   :align: center
   :caption: ros_fun_py_trees_ros_tutorials.eight_dynamic_application_loading.tutorial_create_scan_subtree

Dynamic Application Tree (Class)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. literalinclude:: ../ros_fun_py_trees_ros_tutorials/eight_dynamic_application_loading.py
   :language: python
   :linenos:
   :lines: 380-384
...
.. code-block:: bash
    ...
    # Launch the tutorial
    $ ros2 launch ros_fun tutorial_eight_dynamic_application_loading_launch.py

...
.. code-block:: bash
   ...
   $ py-trees-render -b ros_fun_py_trees_ros_tutorials.five_action_clients.tutorial_create_root

.. graphviz:: dot/tutorial-five-action-clients.dot
   :align: center

.. literalinclude:: ../ros_fun_py_trees_ros_tutorials/five_action_clients.py
   :language: python
   :linenos:
   :lines: 208-307
...
.. code-block:: bash
    ...
    $ ros2 launch ros_fun tutorial_five_action_clients_launch.py

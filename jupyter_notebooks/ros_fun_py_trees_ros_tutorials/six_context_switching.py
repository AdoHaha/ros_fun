...
.. code-block:: bash
   ...
   $ py-trees-render -b ros_fun_py_trees_ros_tutorials.six_context_switching.tutorial_create_root

.. graphviz:: dot/tutorial-six-context-switching.dot
   :align: center

.. literalinclude:: ../ros_fun_py_trees_ros_tutorials/six_context_switching.py
   :language: python
   :linenos:
   :lines: 132-232
...
The :class:`ros_fun_py_trees_ros_tutorials.behaviours.ScanContext` is the
...
.. code-block:: bash
    ...
    # Launch the tutorial
    $ ros2 launch ros_fun tutorial_six_context_switching_launch.py

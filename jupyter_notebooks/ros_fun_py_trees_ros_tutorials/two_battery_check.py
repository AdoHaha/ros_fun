...
.. code-block:: bash
   ...
   $ py-trees-render -b ros_fun_py_trees_ros_tutorials.two_battery_check.tutorial_create_root

.. graphviz:: dot/tutorial-two-battery-check.dot
   :align: center

.. literalinclude:: ../ros_fun_py_trees_ros_tutorials/two_battery_check.py
   :language: python
   :linenos:
   :lines: 122-166
...
This tree makes use of the :class:`ros_fun_py_trees_ros_tutorials.behaviours.FlashLedStrip` behaviour.

.. literalinclude:: ../ros_fun_py_trees_ros_tutorials/behaviours.py
   :language: python
   :linenos:
   :lines: 29-110
...
.. code-block:: bash
    ...
    $ ros2 launch ros_fun tutorial_two_battery_check_launch.py
